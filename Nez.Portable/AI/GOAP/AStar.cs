...
namespace Nez.AI.GOAP
{
	...
	public class AStar
	{
		static AStarStorage _storage = new AStarStorage();
        ...
        */
		...
		public static Stack<Action> Plan( ActionPlanner ap, WorldState start, WorldState goal, List<AStarNode> selectedNodes = null )
		{
			...
			while( true )
			{
				...
				{
					var cur = neighbors[i];
					var opened = _storage.FindOpened( cur );
					var closed = _storage.FindClosed( cur );
