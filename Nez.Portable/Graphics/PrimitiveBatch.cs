...
namespace Nez
{
	...
	public class PrimitiveBatch : IDisposable
	{
		...
		public PrimitiveBatch( int bufferSize = 500 )
		{
			...
			_basicEffect = new BasicEffect( Core.CoreGraphicsDevice );
		...
		public void Begin()
		{
			var projection = Matrix.CreateOrthographicOffCenter( 0, Core.CoreGraphicsDevice.Viewport.Width, Core.CoreGraphicsDevice.Viewport.Height, 0, 0, -1 );
		...
		void FlushTriangles()
		{
			...
			if( _triangleVertsCount >= 3 )
			{
				...
				Core.CoreGraphicsDevice.SamplerStates[0] = SamplerState.AnisotropicClamp;
				Core.CoreGraphicsDevice.DrawUserPrimitives( PrimitiveType.TriangleList, _triangleVertices, 0, primitiveCount );
		...
		void FlushLines()
		{
			...
			if( _lineVertsCount >= 2 )
			{
				...
				// submit the draw call to the graphics card
				Core.CoreGraphicsDevice.SamplerStates[0] = SamplerState.AnisotropicClamp;
				Core.CoreGraphicsDevice.DrawUserPrimitives( PrimitiveType.LineList, _lineVertices, 0, primitiveCount );
