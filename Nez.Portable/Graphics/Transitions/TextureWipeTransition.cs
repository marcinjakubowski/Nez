...
namespace Nez
{
	...
	public class TextureWipeTransition : SceneTransition
	{
		...
		public TextureWipeTransition( Func<Scene> sceneLoadAction, Texture2D transitionTexture ) : base( sceneLoadAction, true )
		{
			...
			_textureWipeEffect = Core.GlobalContent.LoadEffect( "Content/nez/effects/transitions/TextureWipe.mgfxo" );
			Opacity = 1f;
			Color = Color.Black;
		...
		public TextureWipeTransition( Func<Scene> sceneLoadAction ) : this( sceneLoadAction, Core.GlobalContent.Load<Texture2D>( "nez/textures/textureWipeTransition/angular" ) )
		{}


		public TextureWipeTransition() : this( null, Core.GlobalContent.Load<Texture2D>( "nez/textures/textureWipeTransition/angular" ) )
		{}
		...
		public override IEnumerator OnBeginTransition()
		{
			...
			Core.GlobalContent.UnloadEffect( _textureWipeEffect );
		}


		public override void Render( Graphics graphics )
		{
			GraphicsDeviceExt.SetRenderTarget(Core.CoreGraphicsDevice, null );
