...
namespace Nez.DeferredLighting
{
	...
	{
		EffectPass _clearGBufferPass;
		EffectPass _pointLightPass;
		EffectPass _spotLightPass;
		EffectPass _areaLightPass;
		EffectPass _directionalLightPass;
		EffectPass _finalCombinePass;
		...
		public DeferredLightEffect() : base( Core.CoreGraphicsDevice, EffectResource.DeferredLightBytes )
		{
