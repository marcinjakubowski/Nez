...
namespace Nez.DeferredLighting
{
	...
	public class PolygonMesh : IDisposable
	{
		...
		public PolygonMesh( Vector2[] points )
		{
			...
			_vertexBuffer = new VertexBuffer( Core.CoreGraphicsDevice, VertexPosition.VertexDeclaration, verts.Length, BufferUsage.WriteOnly );
			_vertexBuffer.SetData( verts );
			_indexBuffer = new IndexBuffer( Core.CoreGraphicsDevice, IndexElementSize.SixteenBits, indices.Length, BufferUsage.WriteOnly );
		...
		public void Render()
		{
			...
			Core.CoreGraphicsDevice.DrawIndexedPrimitives( PrimitiveType.TriangleList, 0, 0, _primitiveCount );
		}
