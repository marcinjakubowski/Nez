...
namespace Nez
{
	...
	public class Mesh : RenderableComponent
	{
		...
		public override void Render( Graphics graphics, Camera camera )
		{
			...
			{
				Core.CoreGraphicsDevice.DrawUserIndexedPrimitives( _primitiveType, _verts, 0, _verts.Length, _triangles, 0, _primitiveCount );
			}
			else if( _primitiveType == PrimitiveType.TriangleStrip )
			{
				Core.CoreGraphicsDevice.DrawUserPrimitives( _primitiveType, _verts, 0, _verts.Length - 2 );
			}
		}
