...
namespace Nez
{
	...
	public class LineRenderer : RenderableComponent
	{
		...
		public EndCapType EndCap { get; protected set; } = EndCapType.Standard;
		...
		/// <summary>
		/// sets the EndCap used for rendering the line
		/// </summary>
		...
		public override void Render( Graphics graphics, Camera camera )
		{
			...
			Core.CoreGraphicsDevice.SamplerStates[0] = Core.DefaultWrappedSamplerState;
