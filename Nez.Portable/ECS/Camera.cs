	...
	public class Camera : Component
	{
		...
		public RectangleF Bounds
		{
			get
			{
				...
				if( _areBoundsDirty )
				{
					...
					var topLeft = ScreenToWorldPoint( new Vector2( Core.CoreGraphicsDevice.Viewport.X + _inset.Left, Core.CoreGraphicsDevice.Viewport.Y + _inset.Top ) );
					var bottomRight = ScreenToWorldPoint( new Vector2( Core.CoreGraphicsDevice.Viewport.X + Core.CoreGraphicsDevice.Viewport.Width - _inset.Right, Core.CoreGraphicsDevice.Viewport.Y + Core.CoreGraphicsDevice.Viewport.Height - _inset.Bottom ) );
					...
					if ( Entity.Transform.Rotation != 0 )
					{
						...
						var topRight = ScreenToWorldPoint( new Vector2( Core.CoreGraphicsDevice.Viewport.X + Core.CoreGraphicsDevice.Viewport.Width - _inset.Right, Core.CoreGraphicsDevice.Viewport.Y + _inset.Top ) );
						var bottomLeft = ScreenToWorldPoint( new Vector2( Core.CoreGraphicsDevice.Viewport.X + _inset.Left, Core.CoreGraphicsDevice.Viewport.Y + Core.CoreGraphicsDevice.Viewport.Height - _inset.Bottom ) );
		...
		public Matrix ProjectionMatrix
		{
			get
			{
				...
				{
					Matrix.CreateOrthographicOffCenter( 0, Core.CoreGraphicsDevice.Viewport.Width, Core.CoreGraphicsDevice.Viewport.Height, 0, 0, -1, out _projectionMatrix );
		...
		public Matrix ProjectionMatrix3D
		{
			get
			{
				var targetHeight = ( Core.CoreGraphicsDevice.Viewport.Height / _zoom );
				var fov = (float)Math.Atan( targetHeight / ( 2f * PositionZ3D ) ) * 2f;
				return Matrix.CreatePerspectiveFieldOfView( fov, Core.CoreGraphicsDevice.Viewport.AspectRatio, NearClipPlane3D, FarClipPlane3D );
			}
		}
