...
namespace Nez
{
	...
	public abstract class Inspector
	{
		...
		public static List<Inspector> GetInspectableProperties( object target )
		{
			...
			{
				if( !field.IsPublic && EnumerableExt.Count( field.GetCustomAttributes<InspectableAttribute>() ) == 0 )
					continue;
			...
			foreach( var prop in properties )
			{
				...
				if( ( !prop.GetMethod.IsPublic || !prop.SetMethod.IsPublic ) && EnumerableExt.Count( prop.GetCustomAttributes<InspectableAttribute>() ) == 0 )
					continue;
