...
namespace Nez.UI
{
	public class Button : Table, IInputListener, IGamepadFocusable
	{
		...
		public override void Draw( Graphics graphics, float parentAlpha )
		{
			...
			if( _isDisabled && _style.Disabled != null )
				_background = _style.Disabled;
			else if( _mouseDown && _style.Down != null )
				_background = _style.Down;
			else if( _isChecked && _style.Checkked != null )
				_background = ( _style.CheckedOver != null && _mouseOver ) ? _style.CheckedOver : _style.Checkked;
			else if( _mouseOver && _style.Over != null )
				_background = _style.Over;
			else if( _style.Up != null ) //
				_background = _style.Up;
			SetBackground( _background );
