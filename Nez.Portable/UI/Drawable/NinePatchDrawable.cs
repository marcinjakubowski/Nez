...
namespace Nez.UI
{
	...
	public class NinePatchDrawable : IDrawable
	{
		...
		public NinePatchDrawable( NinePatchSubtexture subtexture )
		{
			...
			MinWidth = _subtexture.NinePatchRects[MiddleLeft].Width + _subtexture.NinePatchRects[MiddleCenter].Width + _subtexture.NinePatchRects[MiddleRight].Width;
			MinHeight = _subtexture.NinePatchRects[TopCenter].Height + _subtexture.NinePatchRects[MiddleCenter].Height + _subtexture.NinePatchRects[BottomCenter].Height;

			// by default, if padding isn't given, we will pad the GlobalContent by the nine patch margins
